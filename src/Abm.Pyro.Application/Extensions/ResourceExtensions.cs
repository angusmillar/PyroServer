...
public static class ResourceExtensions
{
    ...
    public static List<ResourceReference> AllReferenceList(
        this Base? resourceModelBase)
    {
        ...
        ClassMapping? mapping = ModelInfo.ModelInspector.FindOrImportClassMapping(resourceModelBase.GetType());
        if (mapping is null)
        {
        ...
        IEnumerable<PropertyMapping> propertyMappingList = mapping.PropertyMappings.Where(x =>
            ...
            (x.ImplementingType.BaseType is not null &&
             x.ImplementingType.BaseType.Name.Equals(BackboneElementToken, StringComparison.Ordinal)));
    ...
    public static List<FhirUrl> AllUrlList(
        this Base? resourceModelBase)
    {
    ...
    public static List<FhirUri> AllUriList(
        this Base? resourceModelBase)
    {
    ...
    public static List<Uuid> AllUuidList(
        this Base? resourceModelBase)
    {
        ...
        void GetUuidFromBackboneElementCollection(
            PropertyMapping propertyMapping)
        {
        ...
        void GetUuidFromBackboneElement(
            PropertyMapping propertyMapping)
        {
            ArgumentNullException.ThrowIfNull(resourceModelBase);
            object? backboneElementObject = propertyMapping.NativeProperty?.GetValue(resourceModelBase);
        ...
        void GetUuidFromResourceCollection(
            PropertyMapping propertyMapping)
        {
            ArgumentNullException.ThrowIfNull(resourceModelBase);
            object? propertyValueObject = propertyMapping.NativeProperty?.GetValue(resourceModelBase);
    ...
    public static List<Oid> AllOidList(
        this Base? resourceModelBase)
    {
        ...
        void GetOidFromBackboneElementCollection(
            PropertyMapping propertyMapping)
        {
            ArgumentNullException.ThrowIfNull(resourceModelBase);
            object? propertyValueObject = propertyMapping.NativeProperty?.GetValue(resourceModelBase);
        ...
        void GetOidFromBackboneElement(
            PropertyMapping propertyMapping)
        {
            ArgumentNullException.ThrowIfNull(resourceModelBase);
            object? backboneElementObject = propertyMapping.NativeProperty?.GetValue(resourceModelBase);
        ...
        void GetOidFromResourceCollection(
            PropertyMapping propertyMapping)
        {
            ArgumentNullException.ThrowIfNull(resourceModelBase);
            object? propertyValueObject = propertyMapping.NativeProperty?.GetValue(resourceModelBase);
    ...
    private static bool IsBackboneElement(
        PropertyMapping propertyMapping)
    {
        return propertyMapping.ImplementingType.BaseType is not null &&
               propertyMapping.ImplementingType.BaseType.Name == BackboneElementToken;
    }
    ...
    private static void AddIfTypeIsResourceReference(
        object? obj,
        List<ResourceReference> results)
    {
    ...
    private static void AddIfTypeIsFhirUrl(
        object? obj,
        List<FhirUrl> results)
    {
    ...
    private static void AddIfTypeIsFhirUri(
        object? obj,
        List<FhirUri> results)
    {
    ...
    private static void AddIfTypeIsUuid(
        object? obj,
        List<Uuid> results)
    {
        if (obj is Uuid uuid)
    ...
    private static void AddIfTypeIsOid(
        object? obj,
        List<Oid> results)
    {
        if (obj is Oid oid)
