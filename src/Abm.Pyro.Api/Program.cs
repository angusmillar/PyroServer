...
try
{
  ...
  builder.Services.AddScoped<FhirBatchService>().AddScoped<IFhirBundleService, FhirBatchService>(s => s.GetRequiredService<FhirBatchService>());
  builder.Services.AddScoped<FhirTransactionService>().AddScoped<IFhirBundleService, FhirTransactionService>(s => s.GetRequiredService<FhirTransactionService>());
  ...
  builder.Services.AddScoped<ISearchParameterMetaDataGetByBaseResourceType, SearchParameterMetaDataGetByBaseResourceType>();
