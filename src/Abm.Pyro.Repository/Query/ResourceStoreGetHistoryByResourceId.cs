...
public class ResourceStoreGetHistoryByResourceId(
  PyroDbContext context,
  IPaginationSupport paginationSupport) : IResourceStoreGetHistoryByResourceId
{
  public async Task<ResourceStoreSearchOutcome> Get(FhirResourceTypeId resourceType, string resourceId, SearchQueryServiceOutcome searchQueryServiceOutcome)
  {
